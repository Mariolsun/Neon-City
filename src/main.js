...
const levelBlueprint = {
  roads: [
    ...
    { id: 'r-loop-left', coord: { x: 8, y: 10 }, size: { w: 2, h: 68 }, type: 'road', meta: { orientation: 'v' } },
    { id: 'r-loop-right', coord: { x: 134, y: 10 }, size: { w: 2, h: 68 }, type: 'road', meta: { orientation: 'v' } },
    { id: 'r-core-south', coord: { x: 20, y: 24 }, size: { w: 104, h: 2 }, type: 'road', meta: { orientation: 'h' } },
    { id: 'r-core-mid', coord: { x: 20, y: 42 }, size: { w: 104, h: 2 }, type: 'road', meta: { orientation: 'h' } },
    { id: 'r-core-north', coord: { x: 20, y: 60 }, size: { w: 104, h: 2 }, type: 'road', meta: { orientation: 'h' } },
    { id: 'r-west-spine', coord: { x: 40, y: 18 }, size: { w: 2, h: 56 }, type: 'road', meta: { orientation: 'v' } },
    { id: 'r-central-spine', coord: { x: 72, y: 18 }, size: { w: 2, h: 56 }, type: 'road', meta: { orientation: 'v' } },
    { id: 'r-east-spine', coord: { x: 104, y: 18 }, size: { w: 2, h: 56 }, type: 'road', meta: { orientation: 'v' } },
  ],
  buildings: [
    { id: 'b-west-yard', coord: { x: 12, y: 27 }, size: { w: 24, h: 12 }, type: 'building', meta: { style: 'plant', neon: '#ffa35c' } },
    { id: 'b-west-arcology', coord: { x: 12, y: 45 }, size: { w: 24, h: 12 }, type: 'building', meta: { style: 'tower', neon: '#7c7bff' } },
    { id: 'b-core-foundry', coord: { x: 44, y: 27 }, size: { w: 24, h: 12 }, type: 'building', meta: { style: 'reactor', neon: '#9cff57' } },
    { id: 'b-core-plaza', coord: { x: 44, y: 45 }, size: { w: 24, h: 12 }, type: 'building', meta: { style: 'hub', neon: '#1de9ff' } },
    { id: 'b-east-galleria', coord: { x: 76, y: 27 }, size: { w: 24, h: 12 }, type: 'building', meta: { style: 'hub', neon: '#4ce2ff' } },
    { id: 'b-east-reactor', coord: { x: 76, y: 45 }, size: { w: 24, h: 12 }, type: 'building', meta: { style: 'reactor', neon: '#f1ff5e' } },
    { id: 'b-far-east-district', coord: { x: 108, y: 27 }, size: { w: 24, h: 12 }, type: 'building', meta: { style: 'plant', neon: '#ff6fd8' } },
    { id: 'b-far-east-spire', coord: { x: 108, y: 45 }, size: { w: 24, h: 12 }, type: 'building', meta: { style: 'tower', neon: '#ff43b4' } },
  ],
  crossroads: [],
};
